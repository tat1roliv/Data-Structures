package d_LinkedList_Generics.copy;
...
public class ListaLigada<TIPO> {
	...
	//construtores
	public ListaLigada() {
		this.tamanho = 0; //inicializa com 0
	}
	...
	public void remover(TIPO valorProcurado) {
		...
		for (int i=0; i < this.getTamanho(); i++) {
			...
			if(atual.getValor().equals(valorProcurado)) {//equalsIgnoreCase => para comparações entre strings | equals => classe object
